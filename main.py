...
class KeyCounterApp:
    ...
    def create_widgets(self):
        ...
        keys = [
            ...
            # Row 1 (Numbers)
            ["半/全", 5, 50, 1, "backtick"], ["1", 45, 50, 1, "1"], ["2", 85, 50, 1, "2"], ["3", 125, 50, 1, "3"], ["4", 165, 50, 1, "4"], 
            ["5", 205, 50, 1, "5"], ["6", 245, 50, 1, "6"], ["7", 285, 50, 1, "7"], ["8", 325, 50, 1, "8"], ["9", 365, 50, 1, "9"], ["0", 405, 50, 1, "0"],
            ["-", 445, 50, 1, "-"], ["^", 485, 50, 1, "equal"], ["¥", 525, 50, 1, "intl_backslash"], ["BS", 565, 1.4, "backspace"],
            ...
            ["Y", 265, 90, 1, "y"], ["U", 305, 90, 1, "u"], ["I", 345, 90, 1, "i"], ["O", 385, 90, 1, "o"], ["P", 425, 90, 1, "p"], ["@", 465, 90, 1, "bracket_left"],
            ["[", 505, 90, 1, "bracket_right"], ["Enter", 555, 90, 1.4, "enter"], 
            ...
            ["G", 237, 130, 1, "g"], ["H", 277, 130, 1, "h"], ["J", 317, 130, 1, "j"], ["K", 357, 130, 1, "k"], ["L", 397, 130, 1, "l"], [";", 437, 130, 1, "semicolon"],
            [":", 477, 130, 1, "apostrophe"], ["]", 517, 130, 1, "backslash"],

            # Row 4 (ZXCV)
            ["Shift", 5, 170, 2.2, "shift"], ["Z", 93, 170, 1, "z"], ["X", 133, 170, 1, "x"], ["C", 173, 170, 1, "c"], ["V", 213, 170, 1, "v"],
            ["B", 253, 170, 1, "b"], ["N", 293, 170, 1, "n"], ["M", 333, 170, 1, "m"], [",", 373, 170, 1, "comma"], [".", 413, 170, 1, "period"],
            ["/", 453, 170, 1, "slash"], ["ろ", 493, 170, 1, "intl_ro"], ["Shift", 533, 1.8, "shift_r"], ["↑", 660, 170, 1, "up"],
        ...
        for text, x, y, w_mult, k_id in keys:
